                        ...
                        <div class="plan_information_cont">
                            <p class="clearfix short">
                                <span class="fl"><em class="fl"><i>*</i>计划名称:</em>
                                    <input type="text" name="name" id="name" class="fr" value="<?php echo isset($plan['name']) && $plan['name'] ? $plan['name'] : '' ?>"/>
                                </span>
                    ...
                    foreach($plan['order_list'] as $key=>$value) {
                        ...
                        <div class="Order_eg">
                            <div class="order_eg">
                                ...
                                <p class="clearfix short">
                                    <input type="hidden" name="id" value="<?php echo isset($value['id']) && $value['id'] ? $value['id'] : '' ?>" />
					<span class="fl">
						...
						<select class="fr" name="type">
                            ...
                            <span class="fl"><em class="fl"><i>*</i>订单名称:</em>
                                <input type="text" name="name" class="fr" value="<?php echo isset($value['name']) && $value['name'] ? $value['name'] : '' ?>"/>
                                </span>
        ...
        $(".keep_Btn").on("click",function(){
            ...
            $.ajax({
                ...
                "success": function (res) {
                    if (res.ret == 1) {
                        window.location.href='/admin/plan/assignCustomer?plan_id='+id;
                    } else {
                        layer.msg(res.msg);
                    }
                }
