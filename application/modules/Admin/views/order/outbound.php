...
<div id="content" class="order_content">
    <div class="order_title">
        <div class="order_fl fl">
            ...
            ?>
            <?php if($index){?>
                <a href="/Admin/order/index" >PC广告</a>
            <?php }?>
            <?php if($mobileadvert){?>
                <a href="/Admin/order/mobileadvert">移动广告</a>
            <?php }?>
            <?php if($outbound){?>
                <a href="/Admin/order/outbound" class="order_act">外呼</a>
            <?php }?>
            <?php if($data){?>
        ...
        <div class="order_rt fr">
            <form action="/admin/order/outbound" method="get" >
    ...
    <div class="order_cont">
        ...
        <div class="order_num">
            <div class="order_all fl">
                ...
                <span>外呼量:<i><?php echo $all_pv;?></i></span>
            </div>
...
<script>
    ...
    $('#edit_subm').click(function () {
        ...
        var succ_url = '/Admin/Order/outbound';
        $.ajax({
            url: '/Admin/Order/editStatus',
            type: 'POST',
            dataType: 'json',
