...
<div id="content" class="data_content">
    <div class="data_title">
        <div class="data_fl fl">
            ...
            <?php }?>
            <?php if($mobileadvert){?>
                <a href="/Admin/data/mobileadvert">移动广告</a>
            <?php }?>
            <?php if($outbound){?>
            ...
            <?php }?>
            <?php if($other){?>
                <a href="/Admin/data/other" class="data_act">其他</a>
            <?php }?>
        </div>
    ...
    <div class="order_cont">
        <form action="/Admin/Data/other" method="get" >
        ...
        <div class="order_num">
            <div class="order_all fl">
                ...
                <span>完成量:<i><?php echo $list['sum_pv'] ? $list['sum_pv'] : 0?></i></span>
            </div>
