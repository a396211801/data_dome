...
<div id="content" class="data_content">
    <div class="data_title">
        <div class="data_fl fl">
            ...
            <?php }?>
            <?php if($data){?>
                <a href="/Admin/data/data" class="data_act">数据</a>
            <?php }?>
            <?php if($other){?>
    ...
    <div class="order_cont">
        <form action="/Admin/Data/data" method="get" >
        ...
        <div class="order_num">
            <div class="order_all fl">
                ...
                <span>数据量:<i><?php echo $list['sum_pv'] ? $list['sum_pv'] : 0?></i></span>
            </div>
